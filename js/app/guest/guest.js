...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const title = document.body.getAttribute('data-calendar-title') ?? document.title;
        const details = document.body.getAttribute('data-calendar-details') ?? '';
        const location = document.body.getAttribute('data-calendar-location') ?? '';
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: title,
            dates: `${formatDate(startDate)}/${formatDate(safeEndDate)}`,
            details,
            location,
            ctz: config.get('tz'),
        });
